...
const PerformanceBarChart = ({ data }) => {
  ...
  return (
    <div className="bg-white max-[1px]:bg-slate-800 p-6 rounded-xl shadow-lg h-96">
      <h3 className="text-lg font-semibold mb-4 text-slate-700 max-[1px]:text-slate-200">Desempenho por Disciplina (%)</h3>
      {chartData.length === 0 ? (
        <p className="text-center text-slate-500 max-[1px]:text-slate-400 h-full flex items-center justify-center">
