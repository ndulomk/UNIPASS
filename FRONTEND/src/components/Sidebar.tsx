...
const navigation: NavItemType[] = [
    { path: "/admin", title: "Dashboard", icon: HomeIcon },
    {
        path: "#gestao",
        title: "Gestão",
        icon: UsersIcon,
    ...
    },
    {
        ...
        icon: BookOpenIcon,
        children: [
            { path: "/admin/SchedulingPage", title: "Agendar Provas", icon: CalendarIcon },
    ...
    },
    {
        ...
        icon: ChartBarIcon,
        children: [
            { path: "/admin/resultados", title: "Todos Resultados", icon: ChartBarIcon },
