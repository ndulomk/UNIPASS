...
const StudentHeader: React.FC<AdminHeaderProps> = ({ isCollapsed, onToggleSidebar, onOpenMobileSidebar, studentName }) => {
  return (
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            <button className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 font-medium text-3xl">
              UNIPASS
            </button>
          </div>
        </div>
